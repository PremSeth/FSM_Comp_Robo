...
- [Wall Searching](#wall-searching)
- [Wall Following](#wall-following)
- [Collision Protocol](#collision-protocol)
- [Spiral Path Following](#spiral-path-following)
- [Finite-State Controller](#finite-state-controller)
- [Challenges & Potential Improvements](#challenges--potential-improvements)
- [Final Takeaways](#final-takeaways)

## Wall Searching <a name="wall-searching"></a>

![](images/lidar_rviz.png)

**Figure 1: Lidar mapping of bar_world from the center of the room**
...
## Wall Following <a name="wall-following"></a>
...
## Collision Protocol <a name="collision-protocol"></a>
...
## Spiral Path Following <a name="spiral-path-following"></a>
...
![](images/finite_state_diagram.png)
**Figure 2: finite state diagram for bar-hopping bradley.**
...
## Challenges & Potential Improvements <a name="challenges--potential-improvements"></a>
...
## Contributions
* Prem: I worked on the wall following and bridging everything together in the final fsm node. I also wrote comments for the fsm node. 
* Matthew - Introduction and writeup format, bump_protocol code and writeup, contributed to takeaways and challenges & improvements. 
* Dionysus - implemented spiral path following, generated ros bags, visualized and included sensor data with rviz2, and tested and modified states and transitions.
...
Recordings are in `bags/`: `full_fsm_controller`, `broken_wall_follow`, `bump_protocl`, and `spiral_path`. From that directory, for example:
...
[Project writeup google doc](https://docs.google.com/document/d/1coxiCGMOocB-7vDXaP9QN-EjGjESF1iph1r0ITvcFLs/edit?usp=sharing)
